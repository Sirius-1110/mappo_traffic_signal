    ...
    def eval(
        ...
        if get_rank() == 0:
                ...
                while not eval_monitor.is_finished():
                    ...
                    for env_id, t in timesteps.items():
                        ...
                        if t.done:
                            ...
                            queue_len = t.info['queue_len']
                            wait_time = t.info['wait_time']
                            delay_time = t.info['delay_time']
                            pressure = t.info['pressure']
                            print("reward", reward)
            ...
            info = {
                ...
                'queue_len_mean': episode_info['queue_len_mean'], 
                'wait_time_mean': episode_info['wait_time_mean'], 
                'delay_time_mean': episode_info['delay_time_mean'], 
                'pressure_mean': episode_info['pressure_mean'], 
